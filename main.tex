...
%% styly kapitol a sekcí
	...
	\titleformat{\chapter}[block]{\scshape\bfseries\LARGE}{\thechapter}{12pt}{\vspace{0pt}}[\vspace{-34pt}]
	...
	\titleformat{\subsubsubsection}[block]{\normalfont\normalsize\bfseries}{\thesubsubsubsection}{1em}{\vspace{-9pt}}
...
\pagestyle{plain}
\setcounter{page}{13} %% úvod by neměla být první stránka, začína na čísle 'součet předchozích + 1'

\input{texts/chapters/texts.tex}
