\section{Backend}\label{sec:impl_backend}
	...
	\subsection{Maily}
	Maily, resp. jejich třídy, slouží k~definování vzhledu a obsahu emailu. Poté, co se vytvoří instance této třídy, která je hydratována (tzn. naplněna daty), data jsou předána příslušnému pohledu, který je poté poslán na požadované emaily.
